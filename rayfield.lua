--[[
	...
	Edited to add custom key handling.
...
local prompt = IMPORT("../Libraries/RayfieldPrompt.lua")()
...
local Icons = IMPORT("../Libraries/RayfieldIcons.lua")()
	...
	if (Settings.KeySystem) then
		...
		if not Passthrough then
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				...
				local KeyFound = Settings.KeySettings.ValidateCallback(KeyMain.Input.InputBox.Text)
				if KeyFound then 
